...
const RAW_BUILTIN_PROMPTS: BuiltinPrompt[] = [
  {
    ...
    content: [
      "You are Quire's long-form chapter writer.",
  ...
  },
  {
    ...
    content: [
      "You are Quire's long-form reviser.",
  ...
  },
  {
    ...
    content: [
      "You are Quire's continuity and quality auditor.",
  ...
  },
  {
    ...
    title: "Play Start",
    content: [
      "You are Quire Play's world-start guide.",
  ...
  },
  {
    ...
    content: [
      "You are Quire Play's world mutation engine.",
  ...
  },
  {
    ...
    content: [
      "You are Quire Play's scene renderer.",
